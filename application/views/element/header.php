...
<!-- Mirrored from htmldemo.net/megan/megan/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jul 2024 03:41:12 GMT -->
...
<body>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="top-bar-right-wrapper">
                                <ul class="topbar-info">
                                    <li><a href="mailto:hello@megan.com"><i class="ion-ios-email-outline"></i>
                                            hello@megan.com</a></li>
                                    <li><i class="ion-clock"></i> Mon - Fri: 9:00 - 19:00 / Closed on Weekends</li>
                                </ul>
                                <div class="language-change-wrapper">
                                    <a href="javascript:void(0)" class="language-change-trigger">
                                        <div class="language-flag">
                                            <img src="<?php echo base_url(); ?>assets/img/icons/en.png" class="img-fluid" alt="">
                                        </div>
                                        <span class="selected-lang">ENG <i class="ion-chevron-down"></i></span>
                                    </a>
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="<?php echo base_url(); ?>assets/img/icons/fr.png" class="img-fluid" alt=""> FR</a>
                                        </li>
                                        <li><a href="#"><img src="<?php echo base_url(); ?>assets/img/icons/de.png" class="img-fluid" alt=""> DE</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header-navigation-wrapper">
                                ...
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="<?php echo base_url(); ?>assets/img/logo/logo-dark.png" class="img-fluid" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="header-navigation border-left border-right">
                                            ...
                                            <ul>
                                                <li class="has-children">
                                                    ...
                                                    <ul class="megamenu megamenu--home-variation">
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo1.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-2.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo2.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-3.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo3.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-4.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo10.jpg" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-5.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo11.jpg" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-6.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo5.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-7.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo4.png" class="img-fluid" alt="">
                                                                </div>
                                                                <h3 class="megamenu--home-variation__item__title">Essential
                                                                    2 Homepage</h3>
                                                            </a>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-8.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo7.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-9.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo6.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-10.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo8.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-11.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo9.png" class="img-fluid" alt="">
                                                                </div>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-12.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo12.jpg" class="img-fluid" alt="">
                                                                </div>
                                                                <h3 class="megamenu--home-variation__item__title">Homepage
                                                                    Demo 12</h3>
                                                            </a>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-13.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo13.jpg" class="img-fluid" alt="">
                                                                </div>
                                                                <h3 class="megamenu--home-variation__item__title">Homepage
                                                                    Demo 13</h3>
                                                            </a>
                                                        ...
                                                        <li class="megamenu--home-variation__item">
                                                            <a href="index-14.html">
                                                                <div class="megamenu--home-variation__item__image">
                                                                    <img src="<?php echo base_url(); ?>assets/img/menu-image/demo14.jpg" class="img-fluid" alt="">
                                                                </div>
                                                                <h3 class="megamenu--home-variation__item__title">Homepage
                                                                    Demo 14</h3>
                                                            </a>
                                                ...
                                                <li class="has-children">
                                                    ...
                                                    <ul class="megamenu megamenu--tab">
                                                        <li class="megamenu--tab__menu bg-img bg-img--menu" data-bg="<?php echo base_url(); ?>assets/img/banner/decor.jpg">
                                                            <nav>
                                                                <div class="nav nav-tabs flex-column" id="nav-tab" role="tablist">
                                                                    <a class="nav-item nav-link active" id="item1-tab" data-bs-toggle="tab" href="#item1" role="tab" aria-selected="true">Industries Layout</a>
                                                                    <a class="nav-item nav-link" id="item2-tab" data-bs-toggle="tab" href="#item2" role="tab" aria-selected="false">Industries Served</a>
                                                                </div>
                                                            </nav>
                                                        </li>
                                                                    ...
                                                                    <li>
                                                                        <div class="menu-widget">
                                                                            <div class="menu-widget__image">
                                                                                <img src="<?php echo base_url(); ?>assets/img/banner/about-500x286.jpg" class="img-fluid" alt="">
                                                                            </div>
                                    ...
                                    <div class="header-navigation__contact">
                                        ...
                                        <div class="header-navigation__contact__content">
                                            ...
                                            <h4 class="sub-text">(+00)888.666.88</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="header-search">
                                    ...
                                    <div class="social-links">
                                        <ul>
                                            <li><a href="http://facebook.com/" data-tippy="Facebook" data-tippy-inertia="false" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder__yellow" data-tippy-placement="bottom"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li><a href="http://twitter.com/" data-tippy="Twitter" data-tippy-inertia="false" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder__yellow" data-tippy-placement="bottom"><i class="ion-social-twitter"></i></a>
                                            </li>
                                            ...
                                            <li><a href="http://linkedin.com/" data-tippy="Linkedin" data-tippy-inertia="false" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder__yellow" data-tippy-placement="bottom"><i class="ion-social-linkedin"></i></a>
                                            </li>
    ...
    <div class="hero-slider-area">
        <div id="rev_slider_2_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="home" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_2_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index="rs-4" data-transition="incube-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url(); ?>assets/img/slider/one/home_00_01.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>assets/img/slider/one/home_00_01.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-5" data-transition="incube-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url(); ?>assets/img/slider/one/home_00_15.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>assets/img/slider/one/home_00_15.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE  -->
                    <li data-index="rs-6" data-transition="incube-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url(); ?>assets/img/slider/one/home_00_16.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo base_url(); ?>assets/img/slider/one/home_00_16.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
    ...
    <div class="featured-project-area bg-img section-space--inner--top--120 section-space--inner--bottom--300" data-bg="<?php echo base_url(); ?>assets/img/patterns/1.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="section-title-content-area">
                                    ...
                                    <div class="video-button-container video-popup">
                                        <a href="https://www.youtube.com/watch?v=9No-FiEInLA" class="section-title-video-button">
                                            <div class="video-play bg-img" data-bg="<?php echo base_url(); ?>assets/img/icons/video-play.png">
                    ...
                    <div class="feature-project-box-wrapper">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="single-feature-project-box">
                                    <div class="single-feature-project-box__image">
                                        <img src="<?php echo base_url(); ?>assets/img/banner/feature1.jpg" class="img-fluid" alt="">
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="single-feature-project-box">
                                    <div class="single-feature-project-box__image">
                                        <img src="<?php echo base_url(); ?>assets/img/banner/feature2.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-feature-project-box__content">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="single-feature-project-box">
                                    <div class="single-feature-project-box__image">
                                        <img src="<?php echo base_url(); ?>assets/img/banner/feature3.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="single-feature-project-box__content">
                            ...
                            <div class="swiper-wrapper feature-project-slider-wrapper">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="feature-project-single-slide__image">
                                                <img src="<?php echo base_url(); ?>assets/img/banner/feature4.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="swiper-slide feature-project-single-slide">
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="feature-project-single-slide__image">
                                                <img src="<?php echo base_url(); ?>assets/img/banner/feature5.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="feature-project-single-slide__content">
                                ...
                                <div class="swiper-slide feature-project-single-slide">
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="feature-project-single-slide__image">
                                                <img src="<?php echo base_url(); ?>assets/img/banner/feature6.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="feature-project-single-slide__content">
        ...
        <div class="industry-slider-content-area">
            <div class="swiper-container industry-slider-content-container">
                <div class="swiper-wrapper industry-slider-content-wrapper">
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/1.jpg">
                            <div class="container">
                    ...
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/2.jpg">
                            <div class="container">
                                <div class="industry-content-inner">
                                    <div class="section-title-area">
                    ...
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/3.jpg">
                            <div class="container">
                                <div class="industry-content-inner">
                                    <div class="section-title-area">
                    ...
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/4.jpg">
                            <div class="container">
                                <div class="industry-content-inner">
                                    <div class="section-title-area">
                    ...
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/5.jpg">
                            <div class="container">
                                <div class="industry-content-inner">
                                    <div class="section-title-area">
                    ...
                    <div class="swiper-slide">
                        <div class="industry-slider-content-single bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/6.jpg">
                            <div class="container">
                                <div class="industry-content-inner">
                                    <div class="section-title-area">
                        ...
                        <div class="swiper-container featured-project-two-slider-container">
                            <div class="swiper-wrapper featured-project-two-slider-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-project-two-single-item">
                                        <div class="feature-project-two-single-item__image">
                                            <img src="<?php echo base_url(); ?>assets/img/projects/2.jpg" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-project-two-single-item">
                                        <div class="feature-project-two-single-item__image">
                                            <img src="<?php echo base_url(); ?>assets/img/projects/3.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="feature-project-two-single-item__content">
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-project-two-single-item">
                                        <div class="feature-project-two-single-item__image">
                                            <img src="<?php echo base_url(); ?>assets/img/projects/4.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="feature-project-two-single-item__content">
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-project-two-single-item">
                                        <div class="feature-project-two-single-item__image">
                                            <img src="<?php echo base_url(); ?>assets/img/projects/5.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="feature-project-two-single-item__content">
                                ...
                                <div class="swiper-slide">
                                    <div class="feature-project-two-single-item">
                                        <div class="feature-project-two-single-item__image">
                                            <img src="<?php echo base_url(); ?>assets/img/projects/6.jpg" class="img-fluid" alt="">
                                        </div>
                                        <div class="feature-project-two-single-item__content">
                            ...
                            <div class="swiper-container testimonial-slider__container">
                                <div class="swiper-wrapper testimonial-slider__wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single-item">
                                            <div class="testimonial-slider__single-item__image">
                                                <img src="<?php echo base_url(); ?>assets/img/testimonial/1.jpg" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single-item">
                                            <div class="testimonial-slider__single-item__image">
                                                <img src="<?php echo base_url(); ?>assets/img/testimonial/2.jpg" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__single-item__content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single-item">
                                            <div class="testimonial-slider__single-item__image">
                                                <img src="<?php echo base_url(); ?>assets/img/testimonial/3.jpg" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__single-item__content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single-item">
                                            <div class="testimonial-slider__single-item__image">
                                                <img src="<?php echo base_url(); ?>assets/img/testimonial/4.jpg" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__single-item__content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__single-item">
                                            <div class="testimonial-slider__single-item__image">
                                                <img src="<?php echo base_url(); ?>assets/img/testimonial/5.jpg" class="img-fluid" alt="">
                                            </div>
                                            <div class="testimonial-slider__single-item__content">
                        ...
                        <div class="swiper-container brand-logo-slider__container">
                            <div class="swiper-wrapper brand-logo-slider__wrapper">
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/1.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/1b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/2.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/2b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/3.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/3b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/4.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/4b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/5.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/5b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/6.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/6b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/7.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/7b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/8.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/8b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide brand-logo-slider__single">
                                    <div class="image">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/9.png" class="img-fluid" alt="">
                                    </div>
                                    <div class="image-hover">
                                        <img src="<?php echo base_url(); ?>assets/img/brand-logo/9b.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row g-0">
            <div class="col-lg-12">
                <div class="project-counter-wrapper">
                    <!-- project counter-bg -->
                    <div class="project-counter-bg bg-img" data-bg="<?php echo base_url(); ?>assets/img/backgrounds/7.jpg"></div>
                                ...
                                <div class="project-counter-single-content-wrapper">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="project-counter-single-content">
                                                <div class="project-counter-single-content__image">
                                                    <img src="<?php echo base_url(); ?>assets/img/icons/tree.png" class="img-fluid" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="project-counter-single-content">
                                                <div class="project-counter-single-content__image">
                                                    <img src="<?php echo base_url(); ?>assets/img/icons/home.png" class="img-fluid" alt="">
                                                </div>
                                                <div class="project-counter-single-content__content">
                    ...
                    <div class="blog-newspaper-content-wrapper">
                        <div class="row">
                                            ...
                                            <div class="swiper-wrapper blog-post-slider__wrapper">
                                                <div class="swiper-slide blog-post-slider__single-slide">
                                                    <div class="blog-post-slider__image section-space--bottom--30">
                                                        <a href="blog-post-image.html"><img src="<?php echo base_url(); ?>assets/img/blog/slider/1.jpg" class="img-fluid" alt=""></a>
                                                    </div>
                                                ...
                                                <div class="swiper-slide blog-post-slider__single-slide">
                                                    <div class="blog-post-slider__image section-space--bottom--30">
                                                        <a href="blog-post-image.html"><img src="<?php echo base_url(); ?>assets/img/blog/slider/2.jpg" class="img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="blog-post-slider__content">
                                                        <p class="post-date"> August 4, 2022</p>
                                                        <h3 class="post-title">
                                                ...
                                                <div class="swiper-slide blog-post-slider__single-slide">
                                                    <div class="blog-post-slider__image section-space--bottom--30">
                                                        <a href="blog-post-image.html"><img src="<?php echo base_url(); ?>assets/img/blog/slider/3.jpg" class="img-fluid" alt=""></a>
                                                    </div>
                                                    <div class="blog-post-slider__content">
                                                        <p class="post-date"> August 4, 2022</p>
                                                        <h3 class="post-title">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="newsletter-box-wrapper bg-img" data-bg="<?php echo base_url(); ?>assets/img/icons/message.png">
    ...
    <div class="support-footer__area">
        <div class="row g-0">
            ...
            <div class="col-md-6">
                <div class="support-footer__single bg-img" data-bg="<?php echo base_url(); ?>assets/img/icons/message.png">
                    Email: tractor@thememove.com
                </div>
            </div>
            <div class="col-md-6">
                <div class="support-footer__single support-footer__single--dark bg-img" data-bg="<?php echo base_url(); ?>assets/img/icons/support.png">
                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="footer-intro-wrapper">
                                    <div class="footer-logo">
                                        <a href="#">
                                            <img src="<?php echo base_url(); ?>assets/img/logo/logo-light.png" class="img-fluid" alt="">
                                        </a>
                                    </div>
